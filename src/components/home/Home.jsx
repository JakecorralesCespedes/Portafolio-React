...
export default function Inicio() {
    ...
    const list = [
        ...
        {
            title: "Uber Eats",
            img: "./dist/src/assets/repositorio2.png",
            fecha: "April 10, 2024",
